...
def runGui(person):
    ...
    listbox.insert(1, "User ID: " + person.id_number)
    listbox.insert(2, "")
    listbox.insert(3, "User Name: " + person.patient_name)
    listbox.insert(4, "")
    listbox.insert(5, "Phone Number: " + person.phone_number)
    listbox.insert(6, "")
    listbox.insert(7, "Address: " + person.address)
    listbox.insert(8, "")
    listbox.insert(9, "Insurance Carrier: " + person.insurance_carrier)
    listbox.insert(10, "")
    listbox.insert(11, "Date of Birth: " + person.date_of_birth)
    listbox.insert(12, "")
    listbox.insert(13, "Gender: " + person.gender)
    listbox.insert(14, "")
    listbox.insert(15, "Primary Care Physician: " + person.primary_care_physician)
    listbox.insert(16, "")
    listbox.insert(17, "Current Medications: " + person.current_meds)
    listbox.insert(18, "")
    listbox.insert(19, "Appointments: " + person.current_appointments)
    listbox.pack()
